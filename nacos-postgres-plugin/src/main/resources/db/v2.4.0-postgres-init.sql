...
(
    ...
    "data_id"            varchar(255) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
...
(
    ...
    "data_id"      varchar(255) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
    "group_id"     varchar(128) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
    "datum_id"     varchar(255) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
    "content"      text COLLATE "pg_catalog"."default"         NOT NULL,
...
(
    ...
    "group_id"     varchar(128) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
    "tenant_id"    varchar(128) COLLATE "pg_catalog"."default"          DEFAULT ''::character varying,
    "tag_id"       varchar(128) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
    "app_name"     varchar(128) COLLATE "pg_catalog"."default"          DEFAULT NULL::character varying,
    "content"      text COLLATE "pg_catalog"."default"         NOT NULL,
    "md5"          varchar(32) COLLATE "pg_catalog"."default"           DEFAULT NULL::character varying,
    "gmt_create"   timestamp(6)                                NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(
    "id"        int8                                        NOT NULL,
    "tag_name"  varchar(128) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
...
(
    "role"     varchar(50) COLLATE "pg_catalog"."default"  NOT NULL DEFAULT NULL::character varying,
    "resource" varchar(255) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
    "action"   varchar(8) COLLATE "pg_catalog"."default"   NOT NULL DEFAULT NULL::character varying
)
;
...
(
    ...
    "kp"            varchar(128) COLLATE "pg_catalog"."default" NOT NULL DEFAULT NULL::character varying,
    "tenant_id"     varchar(128) COLLATE "pg_catalog"."default"          DEFAULT ''::character varying,
